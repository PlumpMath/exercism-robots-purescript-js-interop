...
(function(exports) {
  ...
  var nextBearing = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Robots line 31, column 1 - line 31, column 35: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var interpretBearing = function (v) {
      if (v === "sorth") {
  ...
  var genericCoord = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.Coord" && v.value1.length === 1)) {
      ...
      return new Data_Generic.SigProd("Robots.Coord", [ {
          sigConstructor: "Robots.Coord", 
      ...
      return new Data_Generic.SProd("Robots.Coord", [ function ($dollarq) {
  ...
  var genericBearing = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.North" && v.value1.length === 0)) {
          return new Data_Maybe.Just(North.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.South" && v.value1.length === 0)) {
          return new Data_Maybe.Just(South.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.East" && v.value1.length === 0)) {
          return new Data_Maybe.Just(East.value);
      };
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.West" && v.value1.length === 0)) {
          return new Data_Maybe.Just(West.value);
      };
      return Data_Maybe.Nothing.value;
  }, function ($dollarq) {
      return new Data_Generic.SigProd("Robots.Bearing", [ {
          sigConstructor: "Robots.North", 
          sigValues: [  ]
      }, {
          sigConstructor: "Robots.South", 
          sigValues: [  ]
      }, {
          sigConstructor: "Robots.East", 
          sigValues: [  ]
      }, {
          sigConstructor: "Robots.West", 
          sigValues: [  ]
      } ]);
  }, function (v) {
      if (v instanceof North) {
          return new Data_Generic.SProd("Robots.North", [  ]);
      };
      if (v instanceof South) {
          return new Data_Generic.SProd("Robots.South", [  ]);
      };
      if (v instanceof East) {
          return new Data_Generic.SProd("Robots.East", [  ]);
      };
      if (v instanceof West) {
          return new Data_Generic.SProd("Robots.West", [  ]);
      };
      throw new Error("Failed pattern match at Robots line 12, column 1 - line 12, column 50: " + [ v.constructor.name ]);
  });
  var genericPhysicality = new Data_Generic.Generic(function (v) {
      if (v instanceof Data_Generic.SProd && (v.value0 === "Robots.Physicality" && v.value1.length === 1)) {
      ...
      return new Data_Generic.SigProd("Robots.Physicality", [ {
          sigConstructor: "Robots.Physicality", 
          sigValues: [ function ($dollarq1) {
              return new Data_Generic.SigRecord([ {
                  recLabel: "bearing", 
                  recValue: function ($dollarq2) {
      ...
      return new Data_Generic.SProd("Robots.Physicality", [ function ($dollarq) {
          return new Data_Generic.SRecord([ {
              recLabel: "bearing", 
              recValue: function ($dollarq1) {
  ...
  var updateBearing = function (bs) {
      return function (phys) {
          var newBearing = Data_Maybe.fromMaybe(North.value)(interpretBearing(bs));
          return Optic_Setter.set(bearing(Data_Identity.functorIdentity))(newBearing)(phys);
      };
  };
  exports["North"] = North;
  exports["South"] = South;
  ...
  exports["interpretBearing"] = interpretBearing;
  ...
  exports["step"] = step;
  exports["updateBearing"] = updateBearing;
...
(function(exports) {
  ...
  var main = (function () {
      var phys = {
          ...
          bearing: Robots.North.value
      };
      var newPhys = Robots.runSteps("RAALAL")(phys);
      return function __do() {
          Robots.defaultPhys;
          Robots.updateBearing;
          return Control_Monad_Eff_Console.logShow(Robots.showPhysicality)(newPhys)();
      };
  })();
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
module.exports = PS.Robots
